...
export function clean(input = {}) {
  ...
  return {
    ...
    tokens_in: n(input.tokens_in),
    tokens_out: n(input.tokens_out),
    tokens_cache_write: n(input.tokens_cache_write),
    tokens_cache_read: n(input.tokens_cache_read),
    cost_usd: Number(input.cost_usd) > 0 ? Number(input.cost_usd) : 0,
